package hanakishoppingDatabase;
...
public class ItemListController {
   ...
   * @return
   */
  @RequestMapping(value = "/ItemListView", method = RequestMethod.GET) // URLとのマッピング
   ...
   * @return
   */
  @RequestMapping(value = "/ItemListView", method = RequestMethod.POST) // URLとのマッピング
